...
class NetworkDiagnostics {
    ...
    findAbandonedConflicts() {
        ...
        if (!this.network.conflicts)
            return { totalAbandoned: 0, conflicts: [] };
    ...
    areConflictsSimilar(conflict1, conflict2) {
        return (conflict1.subject === conflict2.subject &&
