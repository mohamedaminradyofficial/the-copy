...
exports.toTextPayload = toTextPayload;
exports.fromTextPayload = fromTextPayload;
...
exports.createNumberedItem = createNumberedItem;
exports.combineSections = combineSections;
exports.extractSection = extractSection;
exports.parseKeyValues = parseKeyValues;
exports.parseListItems = parseListItems;
 ...
 */
function createSectionHeader(title, level = 1) {
 ...
 */
function formatTextReport(title, sections) {
    const parts = [createSectionHeader(title, 1)];
