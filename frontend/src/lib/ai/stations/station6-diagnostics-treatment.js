...
class Station6Diagnostics {
  ...
  constructor(geminiService) {
    ...
    this.debateSystem = new multi_agent_debate_1.MultiAgentDebateSystem(
      geminiService
    );
    this.uncertaintyEngine =
      new uncertainty_quantification_1.UncertaintyQuantificationEngine(
        geminiService
      );
  }
...
//# sourceMappingURL=station6-diagnostics-treatment.js.map
