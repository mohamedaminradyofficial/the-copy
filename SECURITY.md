...
## بوابة أمنية لعمليات الدمج (Security CI Gate)

- يُمنع دمج أي طلب سحب (PR) في حال فشل خط أنابيب الأمن (Security CI) لأي سبب.
- يجب تكوين قواعد حماية الفروع لضمان أن مرور Security CI شرط إلزامي قبل الدمج.
- أي استثناءات مؤقتة تتطلب موافقة كتابية من مسؤول الأمن وتوثيقها في هذا الملف.
